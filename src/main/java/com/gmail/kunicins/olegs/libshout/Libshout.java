...
public class Libshout implements AutoCloseable {
    ...
    /**
     * Initialize the library, using the default libshout shared library file
     * paths.
     * <p>
    ...
    /**
     * Initialize the library, using the default libshout shared library file
     * paths, or the default paths.
     * This method is equivalent to loading the libshout shared library file,
     * then running the following native calls: 
     * <code>
     *     shout_init();
     *     instance = shout_new();
     * </code>
     * If the library has already been loaded (by a previous call to a
     * constructor), it will <b>not</b> be reloaded.
     *
     * @param libraryPath The path of the libshout java shared library file, or
     * null to use the default paths.
     * @throws IOException If an error occurs while initializing or loading of 
     * libshout shared library.
     */
        ...
        try {
            if (!loaded) {
                ...
                if (null != libraryPath) {
                    ...
                    if (!libshoutFound) {
                        throw new IOException("Could not find path to Libshout shared object in possible paths: "
     ...
     * <p>
     * <b>This method is deprecated, use {@link #setMetadata(String)} instead.
     * The key parameter will be ignored. Calling this method is equivalent to running:</b><code>
     *     setMetadata(value);
     * </code>
     * </p>
     *
     ...
     * This corresponds to the following native calls: 
     * <code>
    ...
    public boolean isConnected() {
        return shout_get_connected(this.instance) == CONNECTED;
    }
    ...
    public boolean isPublic() {
        return shout_get_public(this.instance) == 1;
    }
    ...
    public boolean isNonBlocking() {
        return shout_get_nonblocking(this.instance) == 1;
    }
